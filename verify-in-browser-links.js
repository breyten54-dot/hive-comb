...
(async () => {
  ...
  try {
    ...
    const checks = [
      ...
      ['Role-Play draft ready-for-user-review, draft files + forum URL wired', !!rolePlay && rolePlay.draftStatus === 'ready-for-user-review' && rolePlay.submissionUrl === 'https://etaconnect.etacollege.com/mod/forum/view.php?id=462034' && rolePlay.draftPdf === '/files/assessments/bmsr120-la1-role-play-scenarios/BMSR120-LA1-Role-Play-Scenarios-DRAFT.pdf' && rolePlay.draftDocx === '/files/assessments/bmsr120-la1-role-play-scenarios/BMSR120-LA1-Role-Play-Scenarios-DRAFT.docx'],
      ['Interview draft in-progress, draft files + assign URL wired', !!interview && interview.draftStatus === 'in-progress' && interview.submissionUrl === 'https://etaconnect.etacollege.com/mod/assign/view.php?id=499140' && interview.draftPdf === '/files/assessments/bmsr120-key-functions-the-interview/BMSR120-Key-Functions-The-Interview-DRAFT.pdf' && interview.draftDocx === '/files/assessments/bmsr120-key-functions-the-interview/BMSR120-Key-Functions-The-Interview-DRAFT.docx'],
